...
- [二分探索 二分法 違い](https://kimiyuki.net/blog/2020/11/07/binary-search-and-bisection-method/) - 「二分探索」と「二分法」の違いについて、定義の紹介と競技プログラミングという文脈で「にぶたん」が使われる場合に指し示している意味を説明した記事。
...
- [高校数学の美しい物語 〜定期試験から数学オリンピックまで800記事〜](https://mathtrain.jp/) - 高校数学に関する内容を分かりやく解説したWebサイト。大学数学の内容についても記事が多数掲載されている。
