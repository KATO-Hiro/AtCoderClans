...
- [UnionFindTreeに関する知見の諸々](https://noshi91.hatenablog.com/entry/2018/05/30/191943) - 使用頻度の高いデータ構造であるUnion Find Treeに関する計算量と実装のバリエーションを簡潔に解説した記事。また、Union Find Treeの派生系が紹介されており、C++の実装例のリンクもある。
