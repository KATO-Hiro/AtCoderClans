...
- [問題解決のための「アルゴリズム×数学」が基礎からしっかり身につく本](https://www.amazon.co.jp/dp/4297125218/) - [E869120](https://atcoder.jp/users/E869120)さんによる書籍。有名アルゴリズムの紹介だけでなく、関連する数学的知識・アルゴリズムの活用に向けた数学的考察についても解説されている。書籍の詳細な内容や想定読者については、著者による[記事](https://e869120.hatenablog.com/entry/2021/12/02/225743)を参照されたい。また、ソースコード(C++、Python、Java、C)・問題の解答・正誤表が[GitHub](https://github.com/E869120/math-algorithm-book)にアップロードされている。
