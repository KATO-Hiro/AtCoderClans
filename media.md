...
以下の記事は、2019年3月〜2020年9月に公開・更新されたものです。随時、最新の記事を追加する予定です。
...
- [「1000000007で割ったあまり」の求め方を総特集！ 〜 逆元から離散対数まで 〜](https://qiita.com/drken/items/3b4fdf0a78e7a138cd9a) - コンテストで頻出の「10000000071000000007 で割ったあまり」を求める問題への対策をまとめた記事。このような問題が出題される理由の説明から、四則演算・累乗・二項係数など幅広い話題について解説されている。
...
- [問題解決力を鍛える!アルゴリズムとデータ構造](https://www.amazon.co.jp/dp/4065128447/) - [drken](https://atcoder.jp/users/drken)さんによる書籍。内容や難易度については、[ブログ](https://drken1215.hatenablog.com/entry/2020/08/10/041137)に書かれている。また、書籍に掲載されているソースコードや章末問題の略解が[GitHub](https://github.com/drken1215/book_algorithm_solution)にアップロードされている。
