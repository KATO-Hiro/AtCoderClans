...
以下の記事は、2019年3月〜2022年6月に公開・更新されたものです。随時、最新の記事を追加する予定です。
...
- [はまやん はまやん はまやん](https://blog.hamayanhamayan.com/archive/category/%E7%AB%B6%E6%8A%80%E3%83%97%E3%83%AD%E3%82%B0%E3%83%A9%E3%83%9F%E3%83%B3%E3%82%B0) - [hamayanhamayan](https://atcoder.jp/users/hamayanhamayan)さんの解説ブログ。C++で実装されている。
...
- [アルゴリズム的思考力が身につく! プログラミングコンテストAtCoder入門](https://www.amazon.co.jp/dp/404604408X/) - (予約受付中) [drken](https://atcoder.jp/users/drken)さんによる書籍の第3弾(通称、AtCodeer本)。記事「[AtCoderに登録したら次にやること ～ これだけ解けば十分闘える！過去問精選10問 ～](https://qiita.com/drken/items/fd4e5e3630d0f5859067)」を単行本化したAtCoderの入門書。C++とPythonの文法、AtCoder Beginner Contest (ABC)のC問題を解くための典型的な知識などが習得できる。書籍のコンセプト・内容・想定読者については、[著者の紹介記事](https://drken1215.hatenablog.com/entry/atcodeer)も参照されたい。
...
- [パズルで鍛えるアルゴリズム力](https://www.amazon.co.jp/%E3%83%91%E3%82%BA%E3%83%AB%E3%81%A7%E9%8D%9B%E3%81%88%E3%82%8B%E3%82%A2%E3%83%AB%E3%82%B4%E3%83%AA%E3%82%BA%E3%83%A0%E5%8A%9B-%E5%A4%A7%E6%A7%BB-%E5%85%BC%E8%B3%87/dp/4297126796) - [drken](https://atcoder.jp/users/drken)さんによる書籍の第2弾。有名なパズル(数独・虫食い算・迷路など)を題材に、アルゴリズムの考え方を学ぶことができる。書籍の内容・想定読者・伝えたいメッセージなどについては、著者の[紹介記事](https://drken1215.hatenablog.com/entry/2022/04/13/224634)を参照されたい。また、パズルのソルバーと解答、正誤表が[GitHub](https://github.com/drken1215/book_puzzle_algorithm)で公開されている。
...
- [問題解決のための「アルゴリズム×数学」が基礎からしっかり身につく本](https://www.amazon.co.jp/dp/4297125218/) - [E869120](https://atcoder.jp/users/E869120)さんによる書籍(略称: 「アルゴリズム×数学」本、または、#アルゴ数学本([出典](https://twitter.com/e869120/status/1477948316805922817)))。有名アルゴリズムの紹介だけでなく、関連する数学的知識・アルゴリズムの活用に向けた数学的考察についても解説されている。書籍の詳細な内容や想定読者については、著者による[記事](https://e869120.hatenablog.com/entry/2021/12/02/225743)を参照されたい。また、ソースコード(C++、Python、Java、C)・問題の解答・正誤表が[GitHub](https://github.com/E869120/math-algorithm-book)にアップロードされている。
...
- [問題解決力を鍛える!アルゴリズムとデータ構造](https://www.amazon.co.jp/dp/4065128447/) - [drken](https://atcoder.jp/users/drken)さんによる書籍(通称、けんちょん本)。後述する蟻本を読み進めるための基礎が学べる。内容や難易度の詳細は[ブログ](https://drken1215.hatenablog.com/entry/2020/08/10/041137)を参照されたい。また、書籍に掲載されているソースコードや章末問題の略解が[GitHub](https://github.com/drken1215/book_algorithm_solution)にアップロードされている。
  - [yuk1ty/book-algorithm-solution](https://github.com/yuk1ty/book-algorithm-solution) ![GitHub Repo stars](https://img.shields.io/github/stars/yuk1ty/book-algorithm-solution?style=plastic) - 有志が本文のコードをPythonで書き直している。
