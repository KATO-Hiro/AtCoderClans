...
#  Default: 'vscode'
# c.Session.username = 'vscode'

#------------------------------------------------------------------------------
# MultiKernelManager(LoggingConfigurable) configuration
#------------------------------------------------------------------------------
## A class for managing multpiple kernels.
...
#  Choices: any of ['sha3_256', 'sha3_224', 'sha256', 'blake2s', 'sha512', 'sha3_384', 'sha1', 'blake2b', 'sha384', 'sha3_512', 'sha224', 'md5']
#  Default: 'sha256'
