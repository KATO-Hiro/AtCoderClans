...
そこで、AtCoderの非公式サービス・ツールを**日本語**でまとめたページを用意しました。AtCoderユーザ・サービス・ツールなどの開発者・AtCoder運営チーム・企業の採用担当者それぞれに[メリット](https://github.com/KATO-Hiro/AtCoderHub/blob/master/README.md#メリット)があると考えています。
