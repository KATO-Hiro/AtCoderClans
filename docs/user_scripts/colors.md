...
- [AtCoder Heuristic Duration Labels](https://greasyfork.org/ja/scripts/556901-atcoder-heuristic-duration-labels) - ヒューリスティック部門で、短期・長期コンテストを識別するためのアイコン・背景色を追加する。また、カスタマイズも可能。
