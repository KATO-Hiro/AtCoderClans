...
- [AtCoder Pure Dark](https://greasyfork.org/ja/scripts/576556-atcoder-pure-dark) - ダークテーマに変更する。
...
- [AtCoder Highlighter](https://greasyfork.org/ja/scripts/566471-atcoder-highlighter) - 問題文や制約の数字、数式の変数、実行時間制限・メモリ制限を強調する。配色もそれぞれ変更可能。
...
- [AtCoder Problems Problem List Sort Marker](https://greasyfork.org/ja/scripts/585967-atcoder-problems-problem-list-sort-marker) - 「List」ページで、選択した列に ▲ もしくは ▼ を表示する。
...
- [AtCoder Problems Bookmark Highlighter](https://greasyfork.org/ja/scripts/570024-atcoder-problems-bookmark-highlighter) - AtCoder Problems の問題一覧でブックマーク（☆）の付け外しができる。AtCoderの「問題」ページのブックマークと同期される。

    !!! warning "注意"
        ブックマーク済みの問題を一覧として表示する機能は未対応。
