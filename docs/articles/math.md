...
- [1からNまでのnについて、nの約数の個数の総和を求める](https://prd-xxx.hateblo.jp/entry/2025/07/18/232540) - 約数の個数の一般化、反比例のグラフへの言い換えと制約が大きい場合の工夫が整理されている。

### 平方数

- [平方数の末尾に同じ数字はいくつ続く？](https://kiri8128.hatenablog.com/entry/2025/09/09/225217) - 動画「[平方数の末尾に4は何個まで続くか？](https://www.youtube.com/watch?v=SNgKyaAvb4E)」を参考にして、議論が一般化されている。
...
- [1..=N の階乗逆数・ただの逆数を O(N) 時間で前計算する方法（mod p）](https://ngtkana.hatenablog.com/entry/2025/05/11/105210) - 1からNまでの階乗の逆数と逆数を線形時間で前計算する方法が解説されている。
...
- [誘導部分グラフの数え上げ問題](https://ssrs.hatenablog.com/entry/2024/11/23/061141) - グラフのパターン計数問題を線形代数で分析し、補グラフの活用によって高速な解法の有無を判定する方法が紹介されている。
