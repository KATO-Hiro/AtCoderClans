...
- [AtCoderで使用可能なプログラミング言語が3年振りにアップデートされたので、どの言語が選ばれているか調べてみた](https://qiita.com/nabata/items/789a01effaceeeb570a7) - [言語アップデート(2023年版)](https://atcoder.jp/posts/966)が適用されたコンテストを対象として、提出言語別の集計が行われている。
