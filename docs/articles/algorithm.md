...
- [グラフのサイクル検出 (閉路検出) by DFS](https://drken1215.hatenablog.com/entry/2023/05/20/200517) - サイクル(閉路)検出と復元を解説した記事。C++での実装例と探索過程の図解が紹介されている。
