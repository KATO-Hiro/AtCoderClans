...
- [区間add / 0存在判定 Ω(N^(1.333))](https://yosupo.hatenablog.com/entry/2025/05/27/014201) - 数列に対して、区間の加算と0の存在判定を合計N回処理する問題の計算量の下界が示されている。
    - [区間add / 0存在判定 Ω*(N^(1.5))](https://yosupo.hatenablog.com/entry/2025/05/28/023254) - 上記の問題について、Ω*(N^1.5)であることが証明されている。
...
- [ネットワークフロー理論における「最小カット問題」の考え方を総整理！ 〜 カットの理論から現実への応用例まで 〜](https://qiita.com/drken/items/52aafd8c073b37749539) - 最小カット問題の導入・その解釈・応用例の解説に加えて、豊富な演習問題が掲載されている。
...
- [【AtCoder】「実はグラフ」系の問題を何とかしたい](https://qiita.com/yesantikiss/items/3911827526038fbc2188) - 問題文からはグラフに見えない問題を、順序関係・制約・二択に注目してグラフとして捉え直すための着眼点が紹介されている。
...
- [【図解】線形時間の文字列アルゴリズム「Z algorithm」をイラストとアニメーションでかみ砕く](https://qiita.com/Pro_ktmr/items/16904c9570aa0953bf05) - 最長共通接頭辞の長さの配列（Z配列）を線形時間で求める方法について、図やアニメーションで分かりやすく解説している。
