...
- [ヒューリスティック探索 合理的なAIをつくるためのアルゴリズム](https://www.amazon.co.jp/dp/4065392187) - 状態空間問題や探索アルゴリズムを初歩から学ぶことができる書籍。理論的な背景・アルゴリズム・Pythonによる実装や応用例（ゲーム木探索・自動行動計画問題・大規模言語モデルにおける探索手法）が解説されている。
...
- [Revenger～受験で失敗した天才は、競プロで見返すことができるのか？～](https://kakuyomu.jp/works/822139841242329884) - 受験の挫折で鬱屈を抱えた主人公が、同級生の勧誘で始めた競技プログラミングで才能を開花させていく姿を描いた小説。
