---
title: Change Log for October, 2024
---
...
- [#9160](https://github.com/KATO-Hiro/AtCoderClans/pull/9160) - 「[Milestones](../../milestones/green)」ページに、「レーティングの節目に到達した喜びをつづった記事」を掲載。
    - レーティング800から1199まで(緑色)に[Hasu123](https://atcoder.jp/users/Hasu123)さんの記事を追加。
...
- [#9065](https://github.com/KATO-Hiro/AtCoderClans/pull/9065) - [nonon](https://twitter.com/nonon_math)さんのご紹介で、「[Related Contest Sites](../../related_contest_sites)」の「BOJ (Baekjoon Online Judge)」ページに、以下の記事を追加。
