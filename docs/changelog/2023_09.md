...
- [#6943](https://github.com/KATO-Hiro/AtCoderClans/pull/6943) - 「[Milestones](../../milestones/blue)」ページに、「レーティングの節目に到達した喜びをつづった記事」を掲載。
    - レーティング1600から1999まで(青色)に[mono_0812](https://atcoder.jp/users/mono_0812)さんの記事を追加。
...
- [#6766](https://github.com/KATO-Hiro/AtCoderClans/pull/6766) - 「[Scripts](../../scripts)」の「[解説を読む](../../user_scripts/read_editorials)」ページに、以下のユーザスクリプトを追加。
