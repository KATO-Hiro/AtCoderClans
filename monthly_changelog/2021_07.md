...
- [#2442](https://github.com/KATO-Hiro/AtCoderClans/pull/2442) - 「レーティングの節目に到達した喜びをつづった記事」を掲載。
  - レーティング800から1199まで(緑色)に[MDMA](https://atcoder.jp/users/MDMA)さんの記事を追加。
...
- [#2411](https://github.com/KATO-Hiro/AtCoderClans/pull/2411) - 「[Related Contest Sites](https://kato-hiro.github.io/AtCoderClans/related_contest_sites)」ページに、コンテストサイト「入試数学コンテスト」を追加。
...
- [#2397](https://github.com/KATO-Hiro/AtCoderClans/pull/2397) - 記事「AtCoder座談会 - deepblue」を追加。
...
- [#2368](https://github.com/KATO-Hiro/AtCoderClans/pull/2368) - 「レーティングの節目に到達した喜びをつづった記事」を掲載。
  - レーティング800から1199まで(緑色)に[shinsatt](https://atcoder.jp/users/shinsatt)さんの記事を追加。
